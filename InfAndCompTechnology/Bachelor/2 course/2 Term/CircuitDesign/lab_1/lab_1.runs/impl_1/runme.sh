...
HD_PWD='C:/Backup/Less Important/My programs/Git/MIREA/InfAndCompTechnology/Bachelor/2 course/2 Term/CircuitDesign/lab_1/lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_level.tcl -notrace
